...
public class LoginController {
    ...
    public ResponseEntity<?> login(@RequestBody Map<String, String> loginData, HttpSession session) {
        ...
        try {
            ...
            // Devolver la URL del dashboard correspondiente
            String dashboardUrl = "/dashboard-" + tipoUsuario;
            return ResponseEntity.ok().body(Map.of("tipoUsuario", tipoUsuario, "redirectUrl", dashboardUrl));
        } catch (Exception e) {
